...
function createDB(tx) {
    ...
    tx.executeSql('CREATE TABLE IF NOT EXISTS Mobilescoringbreakdown (ID INTEGER NOT NULL primary key,CreatedateUTC TEXT NULL,UpdatedateUTC TEXT NULL,DeletedateUTC TEXT NULL,HTeamID INTEGER NOT NULL,ATeamID INTEGER NOT NULL,GameID INTEGER NOT NULL,H1st INTEGER NULL,A1st INTEGER NULL,H2nd INTEGER NULL,A2nd INTEGER NULL,H3rd INTEGER NULL,A3rd INTEGER NULL,H4th INTEGER NULL,A4th INTEGER NULL,Hot1 INTEGER NULL,Aot1 INTEGER NULL,Hot2 INTEGER NULL,Aot2 INTEGER NULL,Hot3 INTEGER NULL,Aot3 INTEGER NULL,Hot4 INTEGER NULL,Aot4 INTEGER NULL,Month INTEGER NOT NULL,Day INTEGER NOT NULL,Year INTEGER NOT NULL)');
